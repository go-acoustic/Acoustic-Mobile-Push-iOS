...
@property(class, nonatomic, readonly) MCEInboxDatabase * _Nonnull sharedInstance NS_SWIFT_NAME(shared);
 ...
 */
- (NSMutableArray<MCEInboxMessage *> * _Nullable) inboxMessagesAscending:(BOOL)ascending;
 ...
 */
- (MCEInboxMessage * _Nullable) inboxMessageWithInboxMessageId: (NSString * _Nonnull) inboxMessageId;
 ...
 */
- (MCEInboxMessage * _Nullable) inboxMessageWithRichContentId: (NSString * _Nonnull) richContentId;
