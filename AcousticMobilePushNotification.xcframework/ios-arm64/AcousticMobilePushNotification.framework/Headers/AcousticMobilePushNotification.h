...
//! Project version number for AcousticMobilePushNotification.
FOUNDATION_EXPORT double AcousticMobilePushNotificationVersionNumber;

//! Project version string for AcousticMobilePushNotification.
